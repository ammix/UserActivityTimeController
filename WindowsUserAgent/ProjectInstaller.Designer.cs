namespace ParentControlService
{
	partial class ProjectInstaller
	{
		...
		private void InitializeComponent()
		{
			...
			// serviceInstaller
			// 
			this.serviceInstaller.Description = "Service for controlling children computer games";
			this.serviceInstaller.DisplayName = "Parent Control Service";
			this.serviceInstaller.ServiceName = "ParentControlService";
